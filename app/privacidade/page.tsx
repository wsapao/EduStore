...
export const metadata: Metadata = {
  title: `Política de Privacidade — ${escolaNomeFallback}`,
  description: `Como o ${escolaNomeFallback} coleta, usa e protege seus dados pessoais (LGPD).`,
}
...
export default async function PrivacidadePage() {
  ...
  if (user) {
    ...
    if (escolaId) {
      conteudoBanco = await getVersaoAtualTermos({ tipo: 'privacidade', escolaId })
    }
  }
  ...
  if (conteudoBanco) {
    return (
      <main style={{ maxWidth: 760, margin: '0 auto', padding: '40px 20px 80px' }}>
        ...
        >
          Política de Privacidade — {escolaNome}
        </h1>
        <article
          style={{
            marginTop: 24,
