        ...
        <div style={{ display: 'flex', gap: 16, alignItems: 'center', flexWrap: 'wrap' }}>
          <label style={{ display: 'flex', alignItems: 'center', gap: 8, cursor: 'pointer' }}>
            <input
              ...
              style={checkboxStyle}
            />
            <span style={{ fontSize: 13, color: '#cbd5e1' }}>Exigir PIN para resgate</span>
          </label>
          ...
          {exigePin && (
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              />
              <span style={{ fontSize: 13, color: '#94a3b8' }}>dígitos (4–6)</span>
            </div>
          )}
        </div>
      </Field>
      ...
      <Field label="Saldo">
        <label style={{ display: 'flex', alignItems: 'center', gap: 8, cursor: 'pointer' }}>
          <input
            ...
            style={checkboxStyle}
          />
          <span style={{ fontSize: 13, color: '#cbd5e1' }}>Permitir saldo negativo (compras a crédito)</span>
        </label>
      </Field>
