...
export default function CadastroForm({ logoUrl, nome }: { logoUrl?: string | null, nome?: string | null }) {
    ...
    <AuthCard>
      ...
      <div style={{
        ...
        <div style={{
          ...
          boxShadow:'0 4px 16px rgba(0,0,0,.2)', margin:'0 auto 14px', overflow: 'hidden'
        }}>
          {logoUrl ? (
        ...
        <div style={{ color:'rgba(255,255,255,.55)', fontSize:13 }}>
          {nome ?? process.env.NEXT_PUBLIC_ESCOLA_NOME ?? 'Loja Escolar'} · Cadastro
        </div>
      </div>
