  ...
  if (name === 'creative-light') {
    ...
    return {
      ...
      shellVariables: {
        ...
        '--shadow-card-active': '0 0 0 3px rgba(0,136,255,.14), 0 12px 28px rgba(0,136,255,.1)',
        '--shadow-amber': '0 8px 22px rgba(0,136,255,.28)',
      },
      ...
      logoGradient: 'linear-gradient(135deg, #0091ff, #6155f5)',
      logoShadow: '0 8px 18px rgba(0,136,255,.25)',
      titleColor: '#000000',
      subtitleColor: '#1e6ef4',
      sectionLabelColor: 'rgba(60, 60, 67, 0.6)',
      navText: '#3c3c43',
      navTextActive: '#0088ff',
      navIconActive: '#0088ff',
